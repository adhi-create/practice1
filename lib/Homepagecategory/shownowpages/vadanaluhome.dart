...
class Vadanaluhome extends StatefulWidget {
  const Vadanaluhome({
    super.key,
  });

  @override
  State<Vadanaluhome> createState() => _vadanaluState();
}

class _vadanaluState extends State<Vadanaluhome> {
  ...
  Widget build(BuildContext context) {
    final dataProvider = Provider.of<ProviderProducts9>(context);
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: GridView.builder(
          ...
          itemCount: dataProvider.data9.length,
          itemBuilder: (context, int index) {
            final reverseindex = dataProvider.data9.length - 1 - index;
            final currentItem = dataProvider.data9[reverseindex];
            final words = dataProvider.data9[reverseindex];
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => DetailsPage(
                            itemDetails: dataProvider.data9[reverseindex])));
              },
              child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: Image.network(
                          dataProvider.data9[reverseindex]['Image'] ?? '',
                          height: 200,
                      ...
                      Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              ' ₹${dataProvider.data9[reverseindex]['price'] ?? '.'}',
                          ...
                          Padding(
                            ...
                            child: Text(
                              dataProvider.data9[reverseindex]['title'] ?? '',
                              style: const TextStyle(
                                fontWeight: FontWeight.w700,
                                fontSize: 16.0,
                              ),
